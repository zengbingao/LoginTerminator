...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GooglePlusHelper.initGooglePlus(MainActivity.this, sign_in_button);
        TwitterHelper.initTwitter(loginButton,MainActivity.this);//pay attention to init fabric in this method.
        customAuthClient = new TwitterAuthClient();
        //TwitterHelper.initTwitterEmail(customAuthClient,MainActivity.this);
        TwitterHelper.initCustomTwitter(MainActivity.this, textView, customAuthClient);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_GOOGLE_PLUS) {
            ...
            if (TwitterHelper.ISFROMCUSTOMTWITTERBUTTON) {
                TwitterHelper.initCustomTwitterOnActivityResult(requestCode, resultCode, data, customAuthClient);
            } else {
                TwitterHelper.initTwitterOnActivityResult(requestCode, resultCode, data);
            }
        }
        if (facebookHelper != null && facebookHelper.facebookCallbackManager != null)
